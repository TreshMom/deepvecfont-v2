...
def process(process_id, font_num_p_process, ttf_fnames, charset, charset_lenw, fonts_file_path, sfd_path, split, opts):
...
def convert_mp(opts):
    ...
    charset = open(f"/Users/anatoli_vasileva/Desktop/char_set/{opts.language}.txt", 'r').read()
    ...
    processes = [mp.Process(target=process, args=(pid, font_num_per_process, ttf_fnames, charset, charset_lenw, fonts_file_path, sfd_path, opts.split, opts)) for pid in range(process_num)]
...
def main():
    ...
    parser.add_argument("--ttf_path", type=str, default='/Users/anatoli_vasileva/Desktop/AddonTTF')
    parser.add_argument('--sfd_path', type=str, default='/Users/anatoli_vasileva/Desktop/AddonSFD')
